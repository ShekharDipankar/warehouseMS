"""
Django settings for cmsTestProject project.

Generated by 'djangocms' command using django CMS 4.1.2 and Django 4.1.2.
...
SECRET_KEY = "django-insecure-_-$^^_8%y=^ssf9a2x)psu159q217c2s$wct$t$ghsj2&=vu@)"
...
ROOT_URLCONF = "cmsTestProject.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            os.path.join(BASE_DIR, "cmsTestProject", "templates"),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "cmsTestProject.wsgi.application"
...
STATICFILES_DIRS = [
    BASE_DIR / "cmsTestProject" / "static",
]
